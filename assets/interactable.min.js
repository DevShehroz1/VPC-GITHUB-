...
function(e) {
                        ...
                        function(e) {
                            ...
                            r.append("sections", w), r.append("sections_url", window.location.pathname), o.body = r, fetch(`${T}`, o).then(e => e.json()).then(e => {
                                ...
                                const intervalId = setInterval(() => {
                                    if (window.monster_refresh && window.openCart) {
    ...
    T4SThemeSP.initLoadMore = function() {
            ...
            s.on("click", w + ":not(." + k + ")", function(n) {
                n.preventDefault(), n.stopPropagation(), h ? function(n) {
                    ...
                    t.addClass(U + " " + P), fetch(B, {
                        ...
                        "success" == t.status ? (Z = JSON.parse(t.response.metafield.value).the4_ids, W = JSON.parse(t.response.metafield.value).ecomrise_ids, Z && (W = W.concat(Z)), Array.isArray(W) || (W = W.split(",")), d(n), E = W.length, e(C).html(E), l(), j && (window.location.href = O)) : console.error(t.message || "Unknow error")
                    }).catch(function(e) {
                        console.log("Error: " + e)
                    }).finally(() => {
                        t.removeClass(U + " " + P)
        ...
        function o(t) {
            ...
            e(w + '[data-id="' + n + '"]').removeClass(k).find(".t4s-text-pr").text(A), e(w + '[data-id="' + n + '"]').find(".t4s-svg-pr-icon").html($), E = N.length, e(C).html(E), r(), j && ("" == N.toString() || z) && (e(".t4s-products-wishlist").fadeTo(300, 0), window.location.href = O)
        }

        function a(t) {
            var n = t.attr("data-id") || "",
                i = t.attr("data-handle") || "ntt4s" + n;
            t.addClass(U + " " + P), fetch(Z.indexOf(n) >= 0 ? H : B, {
                method: "DELETE",
                headers: {
                    "Content-Type": "application/json"
                },
                ...
                if ("success" == i.status) {
                    ...
                    e(w + '[data-id="' + n + '"]').removeClass(k).find(".t4s-text-pr").text(A), e(w + '[data-id="' + n + '"]').find(".t4s-svg-pr-icon").html($), E = W.length, e(C).html(E), l(), j && ("" == N.toString() || z) && (e(".t4s-products-wishlist").fadeTo(300, 0), window.location.href = R)
        ...
        function u() {
            !isStorageSpdLocalAll && h || v || (history.replaceState && j && window.history.replaceState({}, document.title, m + "/?view=wishlist"), h ? r() : l(), j && (window.isEmtyWishlist && window.isWishlistPerformed ? localStorage.removeItem(_) : (window.countWishlistPage != N.length && window.isWishlistPerformed && (e(C).html(window.countWishlistPage), localStorage.setItem(_, window.listIDPrs)), !window.isEmtyWishlist || window.isWishlistPerformed || "" == N.toString() || IsDesignMode || (window.location.href = O))), s.on("click", w + "." + k, function(t) {
        ...
        if (g) var G = e("#wis_t4s_list").html() || "",
